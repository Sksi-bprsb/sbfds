<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AktifitasDiatasJamDuaBelass.aspx.cs" Inherits="SBFDSys.AktifitasDiatasJamDuaBelass" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Aktifitas Diatas Jam 12 Malam </h6>
                            </div>
                            <br>
                                    ...
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("activity_type").ToString() == "LE" ? "Salah Password" : 
                                                            (Eval("activity_type").ToString() == "VS" ? "Lihat Mutasi" :
                                                            (Eval("activity_type").ToString() == "RW" ? "Tutup MB Tidak Aktif" :
                                                            (Eval("activity_type").ToString() == "RV" ? "Tutup IB Tidak Aktif" :
                                                            (Eval("activity_type").ToString() == "1E" ? "Salah Mobile PIN" : 
                                                            (Eval("activity_type").ToString() == "VD" ? "Lihat Deposito" :
                                                            (Eval("activity_type").ToString() == "VL" ? "Lihat Pinjaman" :
                                                            (Eval("activity_type").ToString() == "RX" ? "Tutup IB" :
                                                            (Eval("activity_type").ToString() == "RY" ? "Tutup MB" :
                                                            (Eval("activity_type").ToString() == "LS" ? "Login Sukses" : Eval("activity_type").ToString()))))))))) %></td>
                                                <td><%# Eval("activity_data") %></td>
                                                <td><%# Eval("created") %></td> 
