<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroups.aspx.cs" Inherits="SBFDSys.UserGroups" %>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <%--<h1 class="h3 mb-2 text-gray-800">Input User Gra</h1>--%>
                        <p class="mb-4">Tambah, Ubah, Hapus User Group</p>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Daftar User Group</h6>
                            </div>
                            <br>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="UserGroupAddUpdate.aspx" class="btn btn-success btn-icon-split">
                                            <span class="icon text-white-50">
                                                <i class="fas fa-plus"></i>
                                            </span>
                                            <span class="text">Tambah User Group Baru</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <asp:Button ID="ButtonSearchGroup" runat="server" class="btn btn-primary" type="button" Text="Cari" OnClick="ButtonSearchGroup_Click"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href="UserGroupAddUpdate.aspx?UserRoleId=<%# Eval("UserGroupId") %>"><%# Eval("NamaUserGroup") %></a></td>
                                                
                                                <td>
                                                    <asp:Button ID="ButtonDeleteGroup" runat="server" Text="Hapus" CausesValidation="false"
                                                        Enabled=<%# Eval("Active") %>  CssClass="btn btn-danger" OnClick="ButtonDeleteGroup_Click" />
                                                    <asp:Button ID="ButtonUpdateGroup" runat="server" CausesValidation="false" Text="Ubah"
                                                        Enabled="true" CssClass="btn btn-primary" OnClick="ButtonUpdateGroup_Click" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:ListView>
