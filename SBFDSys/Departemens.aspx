<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departemens.aspx.cs" Inherits="SBFDSys.Departemens" %>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <p class="mb-4">Tambah, Ubah, Hapus Departemen</p>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            ...
                            <br>
                            <%--<a href="Departemes.aspx">Departemens.aspx</a>--%>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="DepartemenAddUpdate.aspx" class="btn btn-success btn-icon-split">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <asp:Button ID="ButtonSearchDepartemen" runat="server" class="btn btn-primary" type="button" Text="Cari" OnClick="ButtonSearchDepartemen_Click"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href="DepartemenAddUpdate.aspx?DepartemenId=<%# Eval("DepartemenId") %>"><%# Eval("KodeDepartemen") %></a></td>
                                                <td><%# Eval("NamaDepartemen") %></td>
                                                <td>
                                                    <asp:Button ID="ButtonDeleteDepartemen" runat="server" Text="Hapus" CausesValidation="false"
                                                        Enabled=<%# Eval("Active") %>  CssClass="btn btn-danger" OnClick="ButtonDeleteDepartemen_Click" />
                                                    <asp:Button ID="ButtonUpdateDepartemen" runat="server" CausesValidation="false" Text="Ubah"
                                                        Enabled="true" CssClass="btn btn-primary" OnClick="ButtonUpdateDepartemen_Click" />
                                                </td>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
