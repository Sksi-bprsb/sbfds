<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cabangs.aspx.cs" Inherits="SBFDSys.Cabangs" %>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <%--<h1 class="h3 mb-2 text-gray-800">Kantor Cabang</h1>--%>
                        <p class="mb-4">Tambah, Ubah, Hapus Kantor Cabang</p>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Daftar Kantor Cabang</h6>
                            </div>
                            <br>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="CabangAddUpdate.aspx" class="btn btn-success btn-icon-split">
                                            <span class="icon text-white-50">
                                                <i class="fas fa-plus"></i>
                                            </span>
                                            <span class="text">Tambah Kantor Cabang Baru</span>
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <asp:Button ID="ButtonSearchCabang" runat="server" class="btn btn-primary" type="button" Text="Cari" OnClick="ButtonSearchCabang_Click"></asp:Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href="CabangAddUpdate.aspx?CabangId=<%# Eval("CabangId") %>"><%# Eval("KodeCabang") %></a></td>
                                                <td><%# Eval("NamaCabang") %></td>
                                                <td>
                                                    <asp:Button ID="ButtonDeleteCabang" runat="server" Text="Hapus" CausesValidation="false"
                                                        Enabled=<%# Eval("Active") %>  CssClass="btn btn-danger" OnClick="ButtonDeleteCabang_Click" />
                                                    <asp:Button ID="ButtonUpdateCabang" runat="server" CausesValidation="false" Text="Ubah"
                                                        Enabled="true" CssClass="btn btn-primary" OnClick="ButtonUpdateCabang_Click" />
                                                </td>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
