<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Masters.aspx.cs" Inherits="SBFDSys.Masters" %>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <p class="mb-4">Tambah, Ubah, Hapus Master Data</p>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Daftar Data Utama</h6>
                            </div>
                            <br>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="MasterAddUpdate.aspx" class="btn btn-success btn-icon-split">
                                ...
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href="MasterAddUpdate.aspx?MasterDataId=<%# Eval("Nik") %>"><%# Eval("Nik") %></a></td>
                                                <td><%# Eval("NamaKaryawan") %></td>
                                                <td><%# Eval("Username") %></td>
                                                <td><%# Eval("Password") %></td>
                                                <td><%# Eval("Email") %></td>
                                                <td><%# Eval("NoHp") %></td>
                                                <td><%# Eval("Departemen") %></td>
                                                <td><%# Eval("Cabang") %></td>
                                                <td><%# Eval("NamaUserGroup") %></td>

                                                <td>
                                                    <asp:Button ID="ButtonDeleteMaster" runat="server" Text="NonAktifkan" CausesValidation="false"
                                                        Enabled=<%# Eval("Active") %> CssClass="btn btn-danger" OnClick="ButtonDeleteMaster_Click" />
                                                    <asp:Button ID="ButtonUpdateMaster" runat="server" CausesValidation="false" Text="Ubah"
                                                        Enabled="true" CssClass="btn btn-primary" OnClick="ButtonUpdateMaster_Click" />
                                                </td>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
