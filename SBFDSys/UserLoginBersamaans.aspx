<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoginBersamaans.aspx.cs" Inherits="SBFDSys.UserLoginBersamaans" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">User Login Bersamaan Channel Berbeda</h6>
                            </div>
                            <br>
                                    ...
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Nama Customer</th>
                                                        <th>Device 1</th>
                                                        <th>Tanggal Login 1</th>
                                                        <th>Device 2</th>
                                                        <th>Tanggal Login 2</th>
                                                        <th>Tanggal</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("first_channel") %></td>
                                                <td><%# Eval("first_login") %></td>
                                                <td><%# Eval("second_channel") %></td>
                                                <td><%# Eval("second_login") %></td>
