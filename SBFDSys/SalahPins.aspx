<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalahPins.aspx.cs" Inherits="SBFDSys.SalahPins" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Aktifitas Salah Password Atau PIN</h6>
                            </div>
                            <br>
                                            ...
                                            <tr>
                                                ...
                                                <td><%# Eval("activity_type").ToString() == "LE" ? "Salah Password" : 
                                                            (Eval("activity_type").ToString() == "1E" ? "Salah Mobile PIN" : 
                                                             Eval("activity_type").ToString()) %></td>
