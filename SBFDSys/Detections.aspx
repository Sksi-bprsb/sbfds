<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detections.aspx.cs" Inherits="SBFDSys.Detections" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Daftar Pencarian Fraud</h6>
                            </div>
                            <br>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <%--<asp:Button runat="server" ID="ButtonKirimData" Class="btn btn-primary" type="button" Text="Kirim Data" OnClick="ButtonKirimData_Click"></asp:Button>--%>
                                ...
                                <div class="table-responsive">
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td><%# Eval("m_customer_id") %></td>
                                                <td><%# Eval("transaction_type") %></td>
                                                <td><%# Eval("transaction_amount") %></td>
                                                <td><%# Eval("transaction_date") %></td>
                                                <td><%# Eval("biller_name") %></td>
                                                <td><%# Eval("Status") %></td>
