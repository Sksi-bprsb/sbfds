<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransaksiBeliPulsaBerturut.aspx.cs" Inherits="SBFDSys.TransaksiBeliPulsaBerturut" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Transaksi Beli Pulsa</h6>
                            </div>
                            <br>
                                    ...
                                    <asp:ListView runat="server" ID="ListViewData" OnPagePropertiesChanging="ListViewData_PagePropertiesChanging">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# String.Format("{0:C0}", Eval("transaction_amount")) %></td>
                                                <td><%# Eval("status") %></td>
                                                <td><%# Eval("transaction_date", "{0:dd-MM-yyyy}") %></td>
                                                <td><%# Eval("transaksi_per_hari") %></td>
